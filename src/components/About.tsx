...
const About = () => {
  ...
  const stats = [
    {
      icon: <Building2 className="text-[#D4AF37]" size={28} />,
      number: "15+",
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r fromMicrofibreo-secondary mb-6"></div>

            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Tiffany Sparkles represents the pinnacle of Microfibre innovation,
              brought to you by
              <span className="text-[#D4AF37] font-semibold">
                {" "}
                Dinesh Gupta Limited
              </span>
              , a trusted name in quality manufacturing for over a decade.
            </p>

            <p className="text-base text-foreground/80 mb-6 leading-relaxed">
              Our journey began with a simple vision: to revolutionize the
              cleaning industry through superior Microfibre technology. Today,
              we're proud to offer products that combine cutting-edge science
              with elegant design, making cleaning not just effective, but
              enjoyable.
            </p>
            ...
            <div className="bg-muted/30 rounded-lg p-6 mb-8">
              ...
              <ul className="space-y-3 text-foreground/80">
                ...
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span>
                    Innovative manufacturing processes for superior performance
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span>
                    Continuous research and development for product improvement
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2 mr-3 flex-shrink-0"></div>
